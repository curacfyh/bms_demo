        ...
        <el-form-item label="平台属性">
            <el-form :inline="true">
                <el-form-item v-for="item in attrArr" :key="item.id" :label="item.attrName">
                    <el-select v-model="item.attrIdAndValueId" style="width: 250px">
                        <el-option
        ...
        <el-form-item label="销售属性">
            <el-form :inline="true">
                <el-form-item :label="item.saleAttrName" v-for="item in saleArr" :key="item.id">
                    <el-select v-model="item.saleIdAndValueId" style="width: 250px">
                        <el-option
...
import { reqSpuImageList, reqSpuSaleAttrs, reqAddSku } from '@/api/product/spu'
...
const initSkuData = async (c1Id: number | string, c2Id: number | string, spu: any) => {
    ...
    //获取对应的销售属性
    let result1: any = await reqSpuSaleAttrs(spu.id)
    //获取照片墙的数据
