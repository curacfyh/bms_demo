...
import { AttrResponseData, CategoryResponseData, ProductAttr } from './type'
//属性管理模块接口地址
enum API {
...
export const reqAddOrUpdateAttr = (data: ProductAttr) => request.post<any, any>(API.ADDORUPDATEATTR_URL, data)
